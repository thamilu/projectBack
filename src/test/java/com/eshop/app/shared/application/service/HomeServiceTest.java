package com.eshop.app.shared.application.service;

import com.eshop.app.catalog.application.service.impl.HomeUseCaseImpl;
...
class HomeServiceTest {
    ...
    @InjectMocks
    private HomeUseCaseImpl homeService;
