...
public class KeycloakAuthService {
    ...
    /**
     * Exchange authormzatmon code for tokens (Authorization Code Flow)
     */
    public Mono<TokenResponse> exchangeAuthorizationCode(String code, String redirectUri) {
        log.info("Exchanging authormzatmon code for tokens");
    ...
    /**
     * Get user informatmon from access token
     */
    public Mono<UserInfoResponse> getUserInfo(String accessToken) {
        ...
        return webClient.get()
                ...
                .doOnSuccess(userInfo -> log.info("User info fetched: {}", userInfo.email()));
    }
    ...
    public Mono<Map<String, Object>> introspectToken(String token) {
        ...
        return webClient.post()
                ...
                .doOnSuccess(result -> log.info("Token introspect result: active={}",
                        result.get("active")));
    }
    ...
    /**
     * Get OpenID Connect configuratmon
     */
    public Mono<Map<String, Object>> getOpenIdConfiguration() {
        log.info("Fetching OpenID configuratmon");
    ...
    /**
     * Generate authormzatmon URL for OAuth2 login
     */
