...
public class KeycloakService {
    ...
    @PostConstruct
    public void init() {
        // [HARDEN] Build a custom ResteasyClient to handle Keycloak schema changes
        // gracefully
        // We register CustomKeycloakJacksonProvider to ignore unknown properties (like
        // "multivalued")
        jakarta.ws.rs.client.Client resteasyClient = jakarta.ws.rs.client.ClientBuilder.newClient()
                .register(new com.eshop.app.core.infrastructure.config.security.keycloak.CustomKeycloakJacksonProvider());
