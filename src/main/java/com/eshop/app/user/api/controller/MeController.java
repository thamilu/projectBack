 ...
 * 
 * <p>
 * This controller exposes authenticated user information directly from the JWT
 * token.
 * It validates the Bearer token and returns backend identity information.
 * </p>
 * 
 * <p>
...
public class MeController {
     ...
     */
    @GetMapping("/me")
    @Operation(summary = "Get Current User Identity", description = "Returns authenticated user information from validated JWT token. Perfect for debugging, user context, and multi-tenant logic.", security = @SecurityRequirement(name = "Bearer Authentication"))
    @ApiResponses({
