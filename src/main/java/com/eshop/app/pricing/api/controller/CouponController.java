package com.eshop.app.pricing.api.controller;
 ...
 */
@io.swagger.v3.oas.annotations.tags.Tag(name = "Coupon Management", description = "Discount coupons, validation, and promotional management")
@RestController
...
public class CouponController {
    ...
    @PostMapping
    @Operation(summary = "Create Coupon", description = "Create a new discount coupon with validation rules")
    ...
    public ResponseEntity<CouponResponse.ValidationResult> validateCoupon(
        ...
        CouponResponse.ValidationResult result = couponService.validateCoupon(code, userId, orderTotal, storeId,
                categoryId);
