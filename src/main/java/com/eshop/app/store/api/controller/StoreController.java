...
@io.swagger.v3.oas.annotations.tags.Tag(name = "Stores", description = "Multi-vendor store management - sellers can create and manage their stores")
@RestController
...
public class StoreController {
    ...
    public StoreController(StoreUseCase storeService) {
