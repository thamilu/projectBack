package com.eshop.app.order.api.controller;
...
@io.swagger.v3.oas.annotations.tags.Tag(name = "Orders", description = "Order management - create, track, and manage customer orders")
@RestController
...
public class OrderController {
    ...
    public ResponseEntity<ApiResponse<PageResponse<OrderResponse>>> getMyOrders(
        ...
        PageResponse<OrderResponse> response = getOrderUseCase.getMyOrders(pageable);
        return ControllerResponseUtils.ok(response);
    }
    ...
    public ResponseEntity<ApiResponse<PageResponse<OrderResponse>>> getAllOrders(
            ...
            @RequestParam(defaultValue = "10") int size) {
        Pageable pageable = PaginationUtils.createPageableWithCreatedAtDesc(page, size);
        PageResponse<OrderResponse> response = getOrderUseCase.getAllOrders(pageable);
        return ControllerResponseUtils.ok(response);
    }
    ...
    public ResponseEntity<ApiResponse<PageResponse<OrderResponse>>> getOrdersByStatus(
            ...
            @RequestParam(defaultValue = "10") int size) {
        Pageable pageable = PaginationUtils.createPageableWithCreatedAtDesc(page, size);
        PageResponse<OrderResponse> response = getOrderUseCase.getOrdersByStatus(status, pageable);
        return ControllerResponseUtils.ok(response);
    }
    ...
    public ResponseEntity<ApiResponse<PageResponse<OrderResponse>>> getOrdersByStore(
            ...
            @RequestParam(defaultValue = "10") int size) {
        Pageable pageable = PaginationUtils.createPageableWithCreatedAtDesc(page, size);
        PageResponse<OrderResponse> response = getOrderUseCase.getOrdersByStore(storeId, pageable);
        return ControllerResponseUtils.ok(response);
    }
    ...
    public ResponseEntity<ApiResponse<OrderResponse>> updateOrderStatus(
        ...
        OrderResponse response = updateOrderUseCase.updateOrderStatus(orderId, status);
    ...
    public ResponseEntity<ApiResponse<OrderResponse>> updatePaymentStatus(
            @PathVariable Long orderId,
            @RequestParam String status) {
        OrderResponse response = updateOrderUseCase.updatePaymentStatus(orderId, status);
    ...
    public ResponseEntity<ApiResponse<OrderResponse>> assignDeliveryAgent(
        ...
        OrderResponse response = updateOrderUseCase.assignDeliveryAgent(orderId, agentId);
    ...
    public ResponseEntity<ApiResponse<PageResponse<OrderResponse>>> getDeliveryAgentOrders(
            ...
            @RequestParam(defaultValue = "10") int size) {
        Pageable pageable = PaginationUtils.createPageableWithCreatedAtDesc(page, size);
        PageResponse<OrderResponse> response = getOrderUseCase.getDeliveryAgentOrders(pageable);
        return ControllerResponseUtils.ok(response);
    }
    ...
    public ResponseEntity<ApiResponse<PageResponse<OrderResponse>>> getSellerOrders(
            ...
            @RequestParam(defaultValue = "10") int size) {
        Pageable pageable = PaginationUtils.createPageableWithCreatedAtDesc(page, size);
        PageResponse<OrderResponse> response = getOrderUseCase.getSellerOrders(pageable);
        return ControllerResponseUtils.ok(response);
    }
}
