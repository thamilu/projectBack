package com.eshop.app.order.api.request;
...
/**
 * Checkout Request DTO containing all necessary information for cart-to-order
 * conversion.
 * 
 * Purpose:
...
public class CheckoutRequest {
     ...
     * - Apartient/Suite number if applicable
