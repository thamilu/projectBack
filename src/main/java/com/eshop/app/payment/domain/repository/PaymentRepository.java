package com.eshop.app.payment.domain.repository;
...
public interface PaymentRepository extends JpaRepository<Payment, Long> {
    ...
    List<Payment> findFailedPaymentsSince(@Param("status") PaymentStatus status, 
    ...
    BigDecimal calculateRevenueByGateway(@Param("gateway") PaymentGateway gateway);
    ...
    List<Payment> findByGatewayAndStatusSince(@Param("gateway") PaymentGateway gateway,
