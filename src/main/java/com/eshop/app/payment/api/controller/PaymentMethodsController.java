...
@io.swagger.v3.oas.annotations.tags.Tag(name = "Payment Methods", description = "Payment method discovery and validation")
@RestController
...
public class PaymentMethodsController {
    ...
    @Operation(summary = "Get Available Payment Methods", description = "Get all available payment methods based on user location and order amount")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "List of available payment methods")
    ...
    public ResponseEntity<Map<String, Object>> getAvailablePaymentMethods(
        ...
        if ("IN".equals(country)) {
            ...
            cardMethods.add(createPaymentMethod("CREDIT_CARD_MASTERCARD", "Mastercard Credit", "card", true, null));
            cardMethods
                    .add(createPaymentMethod("CREDIT_CARD_AMERICAN_EXPRESS", "American Express", "card", true, null));
            cardMethods.add(createPaymentMethod("DEBIT_CARD_VISA", "Visa Debit Card", "card", true, null));
            cardMethods.add(createPaymentMethod("DEBIT_CARD_MASTERCARD", "Mastercard Debit", "card", true, null));
        }
    ...
    @Operation(summary = "Validate Card Details", description = "Validate credit/debit card number and detect card type")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Card validation result")
    @PreAuthorize("hasRole(@appProperties.security.roles.customer) or hasRole(@appProperties.security.roles.admin)")
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "UPI validation result")
    @PreAuthorize("hasRole(@appProperties.security.roles.customer) or hasRole(@appProperties.security.roles.admin)")
    ...
    private Map<String, Object> createPaymentMethod(String code, String name, String type, boolean enabled,
            String description) {
