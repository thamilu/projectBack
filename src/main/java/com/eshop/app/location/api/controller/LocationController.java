package com.eshop.app.location.api.controller;
...
import com.eshop.app.location.application.service.LocationService;
 ...
 *
 * <p>
 * Follows the pincode-first eCommerce UX pattern:
 * <ol>
 ...
 *
 * <p>
 * This endpoint is intentionally <b>public</b> â€” no auth required.
 * Rate-limiting is handled at the gateway layer.
 */
@io.swagger.v3.oas.annotations.tags.Tag(name = "Locations", description = "Pincode-first address lookup â€” powers the eCommerce address auto-fill flow")
@RestController
...
public class LocationController {
     ...
     *
     * @param pincode Indian pincode (6 digits) or international postal code (3â€“10
     *                chars).
     * @return full location hierarchy with a list of localities for the frontend
     *         dropdown.
     */
    @GetMapping("/pincode/{pincode}")
    @Operation(summary = "Pincode lookup", description = "Returns state, district, and locality list for a given pincode. "
    ...
    public ResponseEntity<ApiResponse<LocationResponseDTO>> getByPinCode(
            @Parameter(description = "Pincode â€” 3 to 10 characters (e.g. 570008)") @PathVariable @Size(min = 3, max = 10, message = "Pincode must be between 3 and 10 characters") String pincode) {
