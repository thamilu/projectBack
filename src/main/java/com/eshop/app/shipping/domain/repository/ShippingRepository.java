package com.eshop.app.shipping.domain.repository;
...
public interface ShippingRepository extends JpaRepository<Shipping, Long> {
     ...
     */
    Page<Shipping> findByCarrier(ShippingCarrier carrier, Pageable pageable);
    
    /**
     * Find shippings by method
     */
    Page<Shipping> findByMethod(ShippingMethod method, Pageable pageable);
     ...
     */
    Page<Shipping> findByCarrierAndStatus(ShippingCarrier carrier, 
