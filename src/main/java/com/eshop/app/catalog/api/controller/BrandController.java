...
@io.swagger.v3.oas.annotations.tags.Tag(name = "Brands", description = "Brand management endpoints - product manufacturer/brand management")
@RestController
...
public class BrandController {
    ...
    public BrandController(BrandUseCase brandService) {
