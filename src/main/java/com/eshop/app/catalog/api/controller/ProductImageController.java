...
@io.swagger.v3.oas.annotations.tags.Tag(name = "Product Images", description = "Product image management endpoints")
@RestController
@RequestMapping(ApiConstants.Endpoints.PRODUCT_IMAGES)
@RequiredArgsConstructor
public class ProductImageController {
    
    private final ProductImageUseCase imageService;
