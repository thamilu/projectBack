...
import com.eshop.app.core.validation.AtLeastOneNotNull;
...
public class ProductUpdateRequest extends BaseProductRequest {
    ...
    @Schema(description = "Product name (optional for update)", example = "iPhone 15 Pro Max 512GB")
    ...
    @Schema(description = "SEO-friendly URL slug", example = "iphone-15-pro-max-512gb")
    ...
    @Schema(description = "Short description for listings", example = "iPhone 15 Pro Max - 512GB")
    @Size(max = 500, message = "Short description must not exceed 500 characters")
    private String shortDescription;

    // ==================== PRICING ====================

    @Schema(description = "Regular selling price", example = "1199.99")
    ...
    @Schema(description = "Original price before any discount", example = "1299.99")
    ...
    @Schema(description = "Primary product image URL", example = "https://cdn.example.com/products/new-image.jpg")
    @Size(max = 500, message = "Image URL must not exceed 500 characters")
    @org.hibernate.validator.constraints.URL(message = "Invalid image URL format")
    private String imageUrl;

    @Schema(description = "Additional image URLs", example = "[\"https://cdn.example.com/img1.jpg\", \"https://cdn.example.com/img2.jpg\"]")
    @Size(max = 10, message = "Maximum 10 additional images allowed")
    private Set<@org.hibernate.validator.constraints.URL(message = "Invalid image URL") @Size(max = 500, message = "Image URL too long") String> additionalImages;
    ...
    @Schema(description = "Sub-category name", example = "Premium Smartphones")
    ...
    @Schema(description = "Product tags (replaces existing tags)", example = "[\"smartphone\", \"apple\", \"premium\"]")
    @Size(max = 20, message = "Maximum 20 tags allowed")
    private Set<@NotBlank(message = "Tag cannot be blank") @Size(min = 2, max = 50, message = "Tag must be between 2 and 50 characters") @Pattern(regexp = "^[a-zA-Z0-9-]+$", message = "Tag contains invalid characters") String> tags;

    // ==================== FLAGS ====================

    @Schema(description = "Whether product is featured on homepage", example = "true")
    private Boolean featured;

    @Schema(description = "Whether product is active/visible", example = "true")
    private Boolean active;

    @Schema(description = "Whether product is available for sale", example = "true")
    private Boolean available;

    // ==================== SEO ====================

    @Schema(description = "SEO meta title", example = "Buy iPhone 15 Pro Max 512GB | Best Price")
    @Size(max = 100, message = "Meta title must not exceed 100 characters")
    private String metaTitle;

    @Schema(description = "SEO meta description", example = "Get the new iPhone 15 Pro Max with 512GB storage...")
    @Size(max = 300, message = "Meta description must not exceed 300 characters")
    private String metaDescription;

    @Schema(description = "SEO meta keywords", example = "iphone, apple, smartphone, 5g")
