 ...
 * 
 * <p>
 * Provides sales performance metrics for high-performing products.
...
public class TopSellingProductResponse {
    ...
    @Schema(description = "Total quantity sold", example = "1250", requiredMode = Schema.RequiredMode.REQUIRED)
    private Long totalQuantitySold;

    @Schema(description = "Total revenue generated", example = "1499875.00", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Sales rank (1 = best seller)", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Stock status indicator", example = "IN_STOCK", allowableValues = { "IN_STOCK", "LOW_STOCK",
            "OUT_OF_STOCK" })
