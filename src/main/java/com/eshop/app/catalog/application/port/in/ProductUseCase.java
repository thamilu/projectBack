...
public interface ProductUseCase {
    ...
    PageResponse<ProductListResponse> getProductsByCategory(@NotNull @Positive Long categoryId,
            @NotNull Pageable pageable);
    ...
    default List<TopSellingProductResponse> getTopSellingProductsBySellerId(@NotNull @Positive Long sellerId,
            @Min(1) @Max(MAX_TOP_PRODUCTS) int limit) {
