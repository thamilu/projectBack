...
import com.eshop.app.catalog.application.mapper.CategoryMapper;
...
import static com.eshop.app.core.infrastructure.config.cache.CacheConfig.CATEGORY_LIST_CACHE;
import static com.eshop.app.core.infrastructure.config.cache.CacheConfig.CATEGORIES_CACHE;
...
public class CategoryUseCaseImpl implements CategoryUseCase {
    ...
    @Override
    @Transactional
    @Caching(put = @CachePut(value = CATEGORIES_CACHE, key = "#id"), evict = @CacheEvict(value = CATEGORY_LIST_CACHE, allEntries = true))
    ...
    @Override
    @Cacheable(value = CATEGORY_LIST_CACHE, key = "'page_' + #pageable.pageNumber + '_size_' + #pageable.pageSize + '_sort_' + #pageable.sort.toString()", unless = "#result.content.isEmpty()")
