...
public class DefaultProductService implements ProductUseCase {
    ...
    public void logConfiguration() {
        log.info(
                "ProductUseCase initialized with configuration: lowStockThreshold={}, maxBatchSize={}, maxFriendlyUrlAttempts={}",
    ...
    public ProductResponse createProduct(@Valid @NotNull ProductCreateRequest request, String userId) {
        ...
        try {
            ...
            if (productRepository.existsBySku(request.getSku())) {
                throw new com.eshop.app.catalog.shared.exception.DuplicateSkuException(request.getSku());
            }
            ...
            // Ã¢Å“â€¦ AUTO-RESOLVE STORE: If storeId not provided, get seller's store
            ...
            // MEDIUM-005 FIX: Batch tag resolution (N+1 Ã¢â€ â€™ 2 queries)
    ...
    public ProductResponse recoverFromFailure(Exception ex, ProductCreateRequest request, String userId) {
        ...
        // preserved
        if (ex instanceof com.eshop.app.core.exception.business.DuplicateResourceException
                || ex instanceof com.eshop.app.core.exception.business.DuplicateResourceException
                || ex instanceof com.eshop.app.core.exception.business.ResourceNotFoundException) {
