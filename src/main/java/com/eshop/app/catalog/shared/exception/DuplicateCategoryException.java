...
/**
 * Exception thrown when attempting to create a duplicate category within the
 * same hierarchy path.
 * 
 * <p>
 * This exception indicates a violation of the hierarchical uniqueness
 * constraint where
