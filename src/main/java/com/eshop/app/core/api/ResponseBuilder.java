...
public class ResponseBuilder {
    ...
    public <T> ResponseEntity<ApiResponse<T>> buildCachedResponse(ApiResponse<T> payload, int cacheSeconds,
            boolean isPublic) {
    ...
    public <T> ResponseEntity<ApiResponse<T>> buildETaggedResponse(ApiResponse<T> payload, int cacheSeconds,
            String etag) {
