...
public class StartupValidator {
    ...
    private final com.eshop.app.core.infrastructure.config.properties.JwtProperties jwtProperties;

    public StartupValidator(Environment environment, JdbcTemplate jdbcTemplate, com.eshop.app.core.infrastructure.config.properties.JwtProperties jwtProperties) {
