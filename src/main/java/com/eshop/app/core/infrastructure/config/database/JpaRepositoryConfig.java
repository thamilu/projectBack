package com.eshop.app.core.infrastructure.config.database;
 ...
 * interface com.eshop.app.cart.domain.repository.CartRepository
 ...
 * â”œâ”€â”€ All JPA repositories (Product, User, Order, etc.)
 * â””â”€â”€ (Future: redis/ subfolder if Redis repositories are needed)
 * </pre>
 * 
