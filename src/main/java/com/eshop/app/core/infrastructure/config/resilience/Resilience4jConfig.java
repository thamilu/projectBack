...
public class Resilience4jConfig {
    ...
    /**
     * HIGH-004 FIX: Circuit Breaker Registry with environment-specific
     * configurations.
     * 
     * Strategy:
    ...
    public CircuitBreakerRegistry circuitBreakerRegistry() {
        ...
        CircuitBreakerConfig paymentConfig = CircuitBreakerConfig.custom()
                ...
                .ignoreExceptions(
                        ...
                        com.eshop.app.core.exception.business.ValidationException.class)
                .build();
        ...
        log.info(
                "Circuit breakers configured: paymentGateway (70%, 2min), externalApi (60%, 30s), internalService (50%, 10s)");
        return registry;
    }
