package com.eshop.app.core.infrastructure.config.cache;
    ...
    public CacheManager resilientRedisCacheManager(RedisConnectionFactory connectionFactory) {
        try {
            ...
            log.info("✓ Redis connection successful - distributed caching enabled");
                ...
                com.eshop.app.core.infrastructure.config.serializer.JacksonRedisSerializer jacksonSerializer = new com.eshop.app.core.infrastructure.config.serializer.JacksonRedisSerializer();
