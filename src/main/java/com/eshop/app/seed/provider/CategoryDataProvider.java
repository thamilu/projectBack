...
/**
 * Strategy interface for providing category hierarchy data to the seeding
 * process.
 * 
 * <p>
 * This interface allows for multiple implementations to load category data
...
public interface CategoryDataProvider {
     ...
     * 
     * <p>
     * Each root node may contain nested children forming the complete category
     * tree.
     *
     * @return a list of CategoryNode objects representing the root categories
     * @throws com.eshop.app.exception.CategorySeedingException if data cannot be
     *                                                          loaded
     */
     ...
     * 
     * <p>
     * Used for logging and debugging purposes to identify the data source.
     *
     * @return the provider name (e.g., "code-based", "properties",
     *         "database-config")
     */
