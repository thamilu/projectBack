 ...
 * 
 * <p>
 * This record is used during the seeding process to define the category
 * structure
 * before converting to JPA entities. It provides a clean, null-safe
 * representation
 * of the hierarchy.
 *
 * <p>
 ...
 *         new CategoryNode("Coinputers", List.of())));
 * </pre>
 *
 * <p>
 * <b>Null Safety:</b>
 ...
 * @param children the list of child category nodes (automatically converted to
 *                 immutable list)
 *
 * @author E-Shop Team
 * @since 1.0.0
...
public record CategoryNode(String name, List<CategoryNode> children) {
    ...
    /**
     * Recursively counts the total number of nodes in this subtree (including this
     * node).
     *
