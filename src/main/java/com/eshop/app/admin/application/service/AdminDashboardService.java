...
import com.eshop.app.user.application.service.ActivityService;
        ...
        try {
            ...
            AdminDashboardResponse response = AdminDashboardResponse.builder()
                    ...
                    .systemHealth(AdminDashboardResponse.SystemHealth.builder()
                            .status(AdminDashboardResponse.HealthStatus.HEALTHY).build())
                    .role("ADMIN")
            ...
            return AdminDashboardResponse.builder()
                    ...
                    .systemHealth(AdminDashboardResponse.SystemHealth.builder()
                            .status(AdminDashboardResponse.HealthStatus.DEGRADED).build())
                    .role("ADMIN")
                    .timestamp(Instant.now())
